module cpu_tb();
   ...
   initial begin
      ...
      inst_count = 0;
      trace_file = $fopen("verilogsim.trace_test3");
      sim_log_file = $fopen("verilogsim.log_test3");
